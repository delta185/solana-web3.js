 ...
 */
export function getConstantEncoder<TConstant extends Uint8Array>(
    constant: TConstant,
 ...
 */
export function getConstantDecoder<TConstant extends Uint8Array>(
    constant: TConstant,
 ...
 */
export function getConstantCodec<TConstant extends Uint8Array>(
    constant: TConstant,
